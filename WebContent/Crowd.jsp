...
<nav class="navbar navbar-inverse ">
  ...
  <div class="container-fluid">
	...
	<CENTER>
		<h1>
			<font color="green">Crowd Zones List</font>
		</h1>
	</CENTER>
 <table class="table table-bordered table-dark" style="font-size:25px;">	
 		<thead>
 			<tr>
			<th scope="col"><center><b>Crowd Location</b></center></th>
			<th scope="col"><center><b>Crowd Zone Info</b></center></th>
		...
		<c:forEach var="crowd" items="${crowdList}">
			<tr>
				<td>${crowd.location}</td>
				<td>${crowd.crowdZone}</td>
				<td><img src="./Images/${crowd.photo}" /></td>
			</tr>
