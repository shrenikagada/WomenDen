...
<table class="table table-bordered table-dark" style="font-size:25px;">		
	...
	<tr>
		...
		<c:forEach var="post2" items="${postList}">
			<tr>
				<td>${post2.complaintId}</td>
				<td>${post2.victimId}</td>
				<td>${post2.post}</td>
				<td><img src="./Images/${post2.photo}"/></td>
				<td><center><a href = "SolvedProblems?complaintId=${post2.complaintId}">${post2.professionalId}</a></center></td>
