...
<br><br>
<center>
<form action = "InsertCrowd" method="POST" enctype="multipart/form-data">
	<input type="text" name="location" placeholder="Crowd Location"  /><br><br>
		<textarea class="fontstyle" name = "crowd" placeholder="type here..." style="width:600px;height:200px;" ></textarea>
									 <br><br>
									  <input	type="file" name="photo" required="required"/><br><br>
		<button type="submit"class="btn btn-success " >Add Crowd Zones </button>
				</form></body>
							</center>		
									</div>
